...
<div class="workspace">
                ...
                $q1="select v_id,price,variant from veh_variant where fuel='$c'";
                $r1=mysql_query($q1);
                while($car=mysql_fetch_row($r1))
                {
                $q="select v_name,manufature,img1 from veh_detail where v_id='$car[0]'";
                $r=mysql_query($q);
                ...
                <div class="car" onclick=" window.location.href='car_details.php?man=<?php echo $ro[1];?>&veh=<?php echo $ro[0];?>&vari=<?php echo $car[2];?>' ">
                    <div class="cimg">
                        <img src="<?php echo $ro[2]; ?>" style="width:100%; height:100%;">
                    </div>    
                    <div class="cname">
                        <a href="car_details.php?man=<?php echo $ro[1];?>&veh=<?php echo $ro[0];?>&vari=<?php echo $car[2];?>">
                            <label class="cnf"><br>&nbsp;<?php echo $ro[0]." ".$car[2]; ?></label></a>
                    </div>
                    <div class="cdata">
                        <br><label class="cnf1">Manufacturer : <?php echo $ro[1]; ?></label>
                        <br><br>
                        <label class="cnf1">Price : <?php echo $car[1]; ?></label>
                    </div>
                </div>
                <?php }   } ?>
