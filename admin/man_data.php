...
<html>
<head>
	<title>onwheels-admin | add manufacture</title>
		...
		<div class="user">
            ...
            <ul class="nav sidebar-nav">
                ...
                <li><a href="users.php"><span class="fa fa-user"></span>&nbsp;&nbsp;&nbsp;&nbsp; Users</a></li>
                 <li class="active"><a href="man_data.php"><span class="fa fa-gears"></span>&nbsp;&nbsp;&nbsp;&nbsp;Add Manufacture</a></li>
		...
		<div class="col-lg-10 col-md-10 col-md-offset-2 col-md-offset-2 mainspace">
			    <header id="header">
			      <div class="container-fluid">
			        <div class="row">
			          <div class="col-md-10">
			            <h2><span class="fa fa-gears" aria-hidden="true"></span> Add Manufacture <small>Add new manufacture</small></h2>
			          </div>
			    ...
			    <section id="breadcrumb">
			      <div class="container-fluid">
			        <ol class="breadcrumb">
			          <li class="active">Dashboard / Add Manufacture</li>
			        </ol>
			      </div>
			    </section>
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Manufacture Registration Form</h3>
              </div>
              <div class="panel-body">
                ...
                <div class="space2">
                    <form name="man_frm" method="post" action="man_reg.php" enctype="multipart/form-data">
                        
                    
                    <div class="n"><label>Manufacture Name</label><input class="input" type="text" name="name" required></div>
                    <div class="n"><label>Country</label><input class="input" type="text" name="country" required></div>
                    
                    <div class="n"><label>Emblem</label><input class="input" type="file" name="imgemb" required></div>
