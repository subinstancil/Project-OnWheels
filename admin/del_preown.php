...
<html>
<head>
	<title>onwheels-admin | delete seller</title>
	...
	<div class="row main">
		...
		<div class="user">
            ...
            <ul class="nav sidebar-nav">
                ...
                <li class="active"><a href="del_preown.php"><span class="fa fa-trash"></span>&nbsp;&nbsp;&nbsp;&nbsp; Delete Seller</a></li>
	...
	<div class="well" style="margin-top: 40%;">
		...
		<div class="col-lg-10 col-md-10 col-md-offset-2 col-md-offset-2 mainspace">
			    <header id="header">
			      <div class="container-fluid">
			        <div class="row">
			          <div class="col-md-10">
			            <h2><span class="fa fa-trash" aria-hidden="true"></span> Delete Seller <small>Delete Registerd Sellers</small></h2>
			          </div>
			    ...
			    <section id="breadcrumb">
			      <div class="container-fluid">
			        <ol class="breadcrumb">
			          <li class="active">Dashboard / Delete Seller</li>
			        </ol>
			      </div>
			    </section>
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Delete Seller</h3>
              </div>
              <div class="panel-body">
                ...
                <tr><th>#</th><th>Seller Name</th><th>Vehicle NO</th><th>Manufacture</th><th>Model</th><th>Version</th><th></th></tr>
                 <?php
                     mysql_connect("localhost","root","");
                     mysql_select_db('car_trade');
                      $q="select name,v_name,variant,v_make,regno from preown_reg";
                      $r=mysql_query($q);
                      $x=1;
                      ...
                      ?>  
                        <tr>
                          ...
                          <td><?php echo $ro[1]; ?></td>
                          <td><?php echo $ro[2]; ?></td>
                          <td><input type="button" value="Delete" onclick="window.location.href='delpro.php?no=<?php echo $ro[4];?>'" class="btn btn-danger" /></td>
                        </tr>
      ...
      <script>
         function del()
         {
             ...
             window.location='delpro.php?no='+reg+'';
         }               
     </script>
