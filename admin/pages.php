	...
	<div class="row main">
		...
		<div class="user">
            ...
            <ul class="nav sidebar-nav">
                ...
                <li class="active"><a href="pages.php"><span class="fa fa-file-text"></span>&nbsp;&nbsp;&nbsp;&nbsp; Pages</a></li>
            </ul>
        </nav>
		...
		<div class="col-lg-10 col-md-10 col-md-offset-2 col-md-offset-2 mainspace">
			    <header id="header">
			      <div class="container-fluid">
			        <div class="row">
			          <div class="col-md-10">
			            <h2><span class="fa fa-file-text" aria-hidden="true"></span> Pages <small> Manage Site Pages</small></h2>
			          </div>
