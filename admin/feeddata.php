...
<head>
  ...
  .workspace{
    ...
    .workspace > .feedback > form > .n{
      height: 4em;
      
    }
    .workspace > .feedback > form > .n > label{
	...
	<div class="well" style="margin-top: 40%;">
		...
		<div class="col-lg-10 col-md-10 col-md-offset-2 col-md-offset-2 mainspace">
			    ...
			    <section id="breadcrumb">
			      <div class="container-fluid">
			        <ol class="breadcrumb">
			          <li class="active">Dashboard / View Feedback / complete feedback</li>
			        </ol>
			      </div>
			    </section>
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Complete Feedback</h3>
              </div>
...
$q="select * from feedback where fid='$id'";
$r=mysql_query($q);
?>             
                ...
                <div class="feedback">
                    ...
                    <div class="n"> 
                        <label>Email<span style="float: right;margin-right: 3em;">:</span></label><label><?php echo $ro[0];?></label>                                    
                    </div>
                    <div class="n"> 
                          <label>Subject<span style="float: right;margin-right: 3em;">:</span></label><label><?php echo $ro[2];?></label>                                 
                    </div>
                    
                    <div class="n" style="height: 100px"> 
                        <label>Feedback<span style="float: right;margin-right: 3em;">:</span></label><label><?php echo $ro[3];?></label>                               
                    </div>
