...
<html>
<head>
	<title>onwheels-admin | Dashboard</title>
	...
	<div class="row main">
		...
		<div class="user">
            ...
            <ul class="nav sidebar-nav">
                <li class="active"><a href="admin.php"><i class="fa fa-tachometer " aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Dashboard</a></li>
		...
		<div class="col-lg-10 col-md-10 col-md-offset-2 col-md-offset-2 mainspace">
			    <header id="header">
			      <div class="container-fluid">
			        <div class="row">
			          <div class="col-md-10">
			            <h2><span class="fa fa-tachometer" aria-hidden="true"></span> Dashboard <small>Manage Your Site</small></h2>
			          </div>
              ...
              <div class="panel-body">
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="fa fa-user" aria-hidden="true"></span> <?php 
                       mysql_connect("localhost","root","");
                      mysql_select_db("car_trade");
                      $q="SELECT COUNT(*) as c FROM user_reg";
                      $r=mysql_query($q);
                ...
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="fa fa-file-text" aria-hidden="true"></span> <?php 
                ...
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="fa fa-table" aria-hidden="true"></span> <?php 
                       mysql_connect("localhost","root","");
                      mysql_select_db("car_trade");
                      $q="SELECT COUNT(*) as rw FROM information_schema.tables WHERE table_schema = 'car_trade'";
                      $r=mysql_query($q);
                      while ($row = mysql_fetch_array($r)) {
                        echo "$row[rw]";
                      }
                ...
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="fa fa-signal" aria-hidden="true"></span> <?php 
                       mysql_connect("localhost","root","");
                      mysql_select_db("car_trade");
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  <table class="table table-striped table-hover" id="usrtab">
                      <tr>
                      <th>#</th>
                        <th>Email</th>
                        <th>Login Date</th>
                     ...
                     mysql_connect("localhost","root","");
                     mysql_select_db('car_trade');
                      $q="select email,login_date,login_time from login order by login_date DESC LIMIT 5";
                      $r=mysql_query($q);
                      $x=1;
