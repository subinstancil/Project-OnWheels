    ...
    <div class="user">
      ...
      <nav class="navbar navbar-inverse" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li class="active"><a href="users.php"><span class="fa fa-user"></span>&nbsp;&nbsp;&nbsp;&nbsp; Users</a></li>
		...
		<div class="col-lg-10 col-md-10 col-md-offset-2 col-md-offset-2 mainspace">
			    <header id="header">
			      <div class="container-fluid">
			        <div class="row">
			          <div class="col-md-10">
			            <h2><span class="fa fa-user" aria-hidden="true"></span> Users <small> Manage Site Users</small></h2>
			          </div>
          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="row">
                      <div class="col-md-12">
                          <input class="form-control" type="text" placeholder="Filter Users..." id="filter">
                      </div>
                </div>
                <br>
...
<script>
  ...
  $('#filter').keyup(function() {
    ...
    $.ajax({
      ...
      document.getElementById("usrtab").innerHTML=response; 
      }
      });
