...
<head>
  ...
  <style type="text/css">
    ...
    .space > .space2 > select, .space > .space2 > input{
      height: 2em;
      width: 45%;
      border-color: #34495e;
      border-style: solid;
...
<div class="container-fluid">
	...
	<div class="well" style="margin-top: 40%;">
		...
		<div class="col-lg-10 col-md-10 col-md-offset-2 col-md-offset-2 mainspace">
			    <header id="header">
			      <div class="container-fluid">
			        <div class="row">
			          <div class="col-md-10">
			            <h2><span class="fa fa-paint-brush" aria-hidden="true"></span> Add Car Color <small>Add new car color</small></h2>
			          </div>
			    ...
			    <section id="breadcrumb">
			      <div class="container-fluid">
			        <ol class="breadcrumb">
			          <li class="active">Dashboard / Vehicle Details / Add New Car Color</li>
			        </ol>
			      </div>
			    </section>
              ...
              <div class="panel-body">
                ...
                <div class="space2">
                    ...
                    <select  onchange="man1(this.value)" name="man1" id="man1" style="float: left;" required="">
        ...
        xmlhttp.send();
                                ...
                                <select  id="r1" name="car1" style="float: right;" required="">
                                                                    
                                 
                                </select>          
                        <label style="float: left;">Select the Colour<span style="float: right;">:</span></label>&nbsp;<input type="color" name="code" id="ccode" style="float: right;" required=""> 
                        <label style="float: left;">Add Colour Name<span style="float: right;">:</span></label>&nbsp;&nbsp;<input type="text" name="cname" id="cname" style="float: right;" required="">
                        <center><input type="button" onclick="send()" value="Add Colour" class="but"></center>
