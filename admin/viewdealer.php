...
<html>
<head>
	<title>onwheels -admin | validate</title>
	...
	<div class="well" style="margin-top: 40%;">
		...
		<div class="col-lg-10 col-md-10 col-md-offset-2 col-md-offset-2 mainspace">
			    ...
			    <section id="breadcrumb">
			      <div class="container-fluid">
			        <ol class="breadcrumb">
			          <li class="active">Dashboard / Validate dealer</li>
			        </ol>
			      </div>
			    </section>
              ...
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Validate Dealer</h3>
              </div>
            ...
            <?php
               ...
               $q="select d_id,name,image from dealer_reg where status='wait'";
               $r=  mysql_query($q);
               while($ro= mysql_fetch_row($r))
                 {
            ?>
            <div class="content" onclick="window.location.href='valdealer.php?id=<?php echo $ro[0];?>'">
                <div class="img">
                    <img src="../<?php echo $ro[2];?>" style="width: 100%; height: 100%;">
                </div>
                <div class="data">
                    <center><a href="valdealer.php?id=<?php echo $ro[0];?>" style=" font-size: 24px; text-decoration: none; text-transform: uppercase;"><?php echo $ro[1];?></a></center>
                </div>
            </div>
                <br><br><br>
             <?php } ?>
