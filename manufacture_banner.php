				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-13" id="cl-effect-13">
						<ul class="nav navbar-nav">
							...
							<li class="<?php if($_SESSION['pagex']=="edtdlr"){echo 'active';} ?>"><a href="edit_dealer.php" >Edit Details</a></li>
						...
						<div class="w3_agile_login">
							...
							$user=$_SESSION['manufacture'];
							mysql_connect("localhost","root","");
							mysql_select_db("car_trade");
                      $q="select name from dealer_reg where email='$user'";
                      $r= mysql_query($q);
...
?>
		...
		<div class="agileits_modal_body">
			<form name="pre_chgpass" action="dealer_uppass.php" method="post" enctype="multipart/form-data" onsubmit="return validate()">
